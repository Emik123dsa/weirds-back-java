package com.department.api.filter;
...
public final class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JwtRequestFilter(DepartmentUserService departmentUserService, JWTUtil jwtUtil) {
    ...
    String jwt = null;
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            UserDetails userDetails = this.departmentUserService.loadUserByUsername(username);
